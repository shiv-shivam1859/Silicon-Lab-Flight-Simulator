...
I am building Silicon Lab as a personal project to bridge the gap between computer science and aerospace engineering. My goal is to eventually create a full flight physics simulator, but right now, it is a 3D parametric visualizer with a built-in math engine.
